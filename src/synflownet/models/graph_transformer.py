...
from synflownet.envs.graph_building_env import GraphActionCategorical, GraphActionType, action_type_to_mask
...
class GraphTransformerGFN(nn.Module):
    ...
    def __init__(
        ...
        if self.continuous_action_embs and hasattr(env_ctx, "building_blocks_embs"):
            self._ae = [self.env_ctx.building_blocks_embs.to(get_worker_device())]
