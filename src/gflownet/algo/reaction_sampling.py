...
from gflownet.envs.graph_building_env import ActionIndex, Graph, GraphAction, GraphActionType, action_type_to_mask
from gflownet.envs.synthesis_building_env import ActionCategorical
from gflownet.models.graph_transformer import GraphTransformerSynGFN
        ...
        for t in range(self.max_len):
            ...
            for i, j in zip(not_done(range(n)), range(n)):
                ...
                if graph_actions[j].action is GraphActionType.Stop:
                    ...
                    n_back = self.env.count_backward_transitions(g, check_idempotent=self.correct_idempotent)
                    if n_back > 0:
